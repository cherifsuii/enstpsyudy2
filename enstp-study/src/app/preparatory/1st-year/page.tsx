...
export default function FirstYearPage() {
  ...
  const semester1 = allData['1er_annee_preparatoire_semestre_1'] || [];
  const semester2 = allData['1er_annee_preparatoire_semestre_2'] || [];

  return (
    <div>
      <h1 className="text-4xl font-bold mb-8 text-center">Preparatory Cycle - 1st Year</h1>
